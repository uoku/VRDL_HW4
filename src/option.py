...
parser.add_argument('--data_range', type=str, default='1-285/286-291',
...
parser.add_argument('--block', type=str, default='CAEctBASIC',
                    choices=('BASIC', 'EctBASIC',
                             'EctBOTTLENECK', 'CAEctBASIC'),
